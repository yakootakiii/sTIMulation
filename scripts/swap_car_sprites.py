...
new_load = """const CAT_SPRITE=new Image();CAT_SPRITE.src='/assets/Cat_nobg.png';let CAT_READY=false;CAT_SPRITE.onload=()=>{CAT_READY=true;};CAT_SPRITE.onerror=()=>{CAT_READY=false;};const CAR_SPRITES=[new Image(),new Image(),new Image()];const CAR_READY=[false,false,false];['/assets/Car_01.png','/assets/Car_02.png','/assets/Car_03.png'].forEach((src,idx)=>{CAR_SPRITES[idx].src=src;CAR_SPRITES[idx].onload=()=>{CAR_READY[idx]=true;};CAR_SPRITES[idx].onerror=()=>{CAR_READY[idx]=false;};});"""
